...
# Script to encode diabetes-lens.js to base64 and update diabetes-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/diabetes-lens.js"
JSON_FILE="$PROJECT_DIR/diabetes-lens.json"
...
console.log('✅ Updated diabetes-lens.json with encoded JS');
"
